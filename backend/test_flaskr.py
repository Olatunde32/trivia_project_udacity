...
class TriviaTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.database_path = "postgres://postgres:adeoluwa@".format('localhost:5432', self.database_name)
    ...
    def test_404_error_requesting_non_existing_category(self):
        res = self.client().get('/categories/50000')
        data = json.loads(res.data)
        self.assertEqual(res.status_code, 404)
        self.assertEqual(data['success'], False)
        self.assertEqual(data['message'], 'resource not found')
    ...
    def test_add_question(self):
        ...
        res = self.client().post('/questions', json=add_new_question)
        data = json.loads(res.data)
    ...
    def test_404_error_get_questions_per_category(self):
